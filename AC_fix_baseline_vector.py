...
def train_actor_critic(env, num_episodes, lr, gamma, hidden_size, wandb_project, use_bootstrapping, use_baseline, lr_step_size, lr_gamma):
    ...
    policy_net = Policy(env.observation_space.shape[0], hidden_size, env.action_space.n)
    value_net = Value(env.observation_space.shape[0], hidden_size)
...
if __name__ == '__main__':    
    ...
    parser.add_argument('--lr_gamma', type=float, default=0.90, help='learning rate decay factor')
